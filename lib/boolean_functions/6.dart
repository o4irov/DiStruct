    ...
    return GestureDetector(
      onPanUpdate: (details) {
        if (details.delta.dx < 0) {
          Navigator.of(context).push(SlideLeftRoute(page: const SeventhTask()));
        }
        if (details.delta.dx > 0) {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    '6. ДНФ. Постройте ДНФ по заданной функции',
                    style: TextStyle(
                      fontSize: 24,
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                IconButton(
                  onPressed: () {
                    Navigator.of(context)
                        .push(SlideLeftRoute(page: const SeventhTask()));
                  },
