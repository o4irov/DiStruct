  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onPanUpdate: (details) {
        ...
        if (details.delta.dx > 2) {
          Navigator.of(context).push(SlideRightRoute(page: const Zero()));
        }
      },
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              const Text(
                '1. Задайте граф списком смежности и выберете начало обхода в глубину',
                style: TextStyle(
                  fontSize: 24,
                ...
                Row(
                  ...
                  children: [
                    DropdownButton(
                      ...
                      items: createNumberList(_length - 1).map((int item) {
                    ...
                    IconButton(
                      onPressed: () {
                        Navigator.of(context)
                            .push(SlideRightRoute(page: const Zero()));
                      },
